...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card p-4 shadow-lg" style="width: 400px;">
        <h3 class="text-center mb-4" >Import Guru ke Database</h3>
        <div class="mt-2 mb-4">
            <a href="<?= base_url('assets/template.xlsx') ?>" class="btn btn-info" style="color: white;" download>Unduh Format Excel</a>
        </div>
        
        <!-- Form untuk mengimpor file Excel -->
        <form action="<?= site_url('excel/import') ?>" method="post" enctype="multipart/form-data">
            <div class="mb-3">
