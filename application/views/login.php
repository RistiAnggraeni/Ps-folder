                            ...
                            <div class="col-12 col-md-6 mb-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-body rounded" style="background-color: #09B2F5;">
                                        ...
                                        <?php endif; ?>
                                        <form action="<?= site_url('auth_siswa/login'); ?>" method="post">
                                            ...
                                            <a href="<?= site_url('pertama/reset_form');?>" style="color: white;">Lupa Password? Reset</a>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <button class="btn w-100" style="background-color: #2F45F1; color: white;" type="submit">Login</button>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a href="<?= site_url('pertama/login2'); ?>" class="btn w-100" style="background-color: #31D100; color: white;" type="submit">Login dengan akun guru/admin</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
