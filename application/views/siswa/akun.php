                                    ...
                                    <div class="card-body" style="background-color: #09B2F5;">
                                        ...
                                        <form>
                                            ...
                                            <div class="text-center mb-3 mt-5">
                                                ...
                                                <p class="text-white"><?= $user_nis['username']; ?></p>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="number" value="<?= $user_nis['nis']; ?>" style="color: #C7AAAA; "/>
                                                <label for="inputEmail" style="color: #C7AAAA;">NIS</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="<?= $user_nis['nama_lengkap']; ?>" style="color: #C7AAAA;"/>
                                                <label for="inputEmail" style="color: #C7AAAA;">Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="<?= $user_nis['kelas']; ?>" style="color: #C7AAAA;"/>
                                                <label for="inputEmail" style="color: #C7AAAA;">Kelas</label>
                                            </div>
                                            <div>
                                        ...
                                        <form method="post" action="<?= site_url('tambah_data/change_password2');?>">
                                            <div class="form-floating mb-3">
