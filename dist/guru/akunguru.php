                                    ...
                                    <div class="card-body" style="background-color: #09B2F5;">
                                        ...
                                        <form>
                                            ...
                                            <div class="text-center mb-3 mt-5">
                                                ...
                                                <p class="text-white">ghjkl</p>
                                            </div>
                                           
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="Oksigen" style="color: #C7AAAA;"/>
                                                <label for="inputEmail" style="color: #C7AAAA;">Nama Lengkap</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="Ilmu Sihir" style="color: #C7AAAA;"/>
                                                <label for="inputEmail" style="color: #C7AAAA;">Mapel</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="0999999" style="color: #C7AAAA;"/>
                                                <label for="inputEmail" style="color: #C7AAAA;">No Hp</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" readonly id="inputEmail" type="text" value="Guru" style="color: #C7AAAA;"/>
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" type="password" placeholder="Password" />
                                                <label for="inputPassword" style="color: #C7AAAA;">Masukkan Ulang Password</label>
                                            </div>
