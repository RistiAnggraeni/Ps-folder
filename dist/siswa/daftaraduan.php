                                    ...
                                    <div class="float-sm-end text-white">10/09/2024</div>
                                        <form>
                                            ...
                                            <div class="d-flex justify-content-between mt-4">
                                                <a href="?page=editpengaduan-siswa" class="btn w-auto text-white btn-primary ">Edit</a>
                                                <a href="chat-guru.php" class="btn w-auto text-white btn-danger ">Hapus</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="float-sm-end text-white">10/09/2024</div>
                                        <form>
                                            ...
                                            <div class="form-floating mb-2">
                                                <img src="../assets/img/c1.jpg" class="img-thumbnail w-25" alt="Bukti Foto"  id="foto">
                                            </div>
                                            <div class="form-floating">
                                              <textarea class="form-control" readonly placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">Sekolah Hancur, Coding Meluncur</textarea>
                                              <label for="floatingTextarea2">Isi Pengaduan</label>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0 col-md-2 ms-auto p-2">
                                                <a href="?page=chat-siswa" class="btn w-100 text-white btn-success">Lihat Tanggapan</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
