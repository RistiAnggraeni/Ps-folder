                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="d-flex align-items-center">
                                <a href="?page=daftaraduan" class="btn btn-primary me-3"><i class="bi bi-arrow-left"></i></a>
                                    ...
                                    <div class="float-sm-end text-white">10/09/2024</div>
                                        <form>
                                            <div class="form-floating mb-3 col-md-5">
                                                <input class="form-control" id="inputEmail" type="text"  value="BapakneIma" />
                                                <label for="floatingTextarea2">Kepada : </label>  
                                            </div>
                                            <div class="form-floating mb-3 col-md-5">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="name@example.com" value="Oke Boss" />
                                            ...
                                            <div class="form-floating">
                                              <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">Ngaso Sek Bolo</textarea>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0 col-md-2 ms-auto p-2">
                                                <button class="btn w-100 text-white btn-primary">Edit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
